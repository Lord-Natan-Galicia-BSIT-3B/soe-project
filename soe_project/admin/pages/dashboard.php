...
// Correct column name: RoomStatus
...
$pendingRequests = 5; // Example static value, update from Requests table if needed
...
<body>
  ...
  <section id="analytics-section">
    <div class="title-section">
      <h2 style="color: #152C5B;">Analytics Overview</h2>
    </div>
  ...
  <div class="graph-container">
    ...
    <div class="graph-info">
      <p>
        <strong style="color: #9FA2B4; font-size: 1rem; font-weight:100;">Total</strong><br>
        <strong style="color: #252733; font-size: 1.3rem;"><?php echo $totalRooms; ?></strong>
      </p>
      <div class="divider"></div>
      <p>
        <strong style="color: #9FA2B4; font-size: 1rem; font-weight:100;">Status</strong><br>
        <strong style="color: #252733; font-size: 1.3rem;">Available</strong>
      </p>
      <div class="divider"></div>
      <p>
        <strong style="color: #9FA2B4; font-size: 1rem; font-weight:100;">Date</strong><br>
        <strong style="color: #252733; font-size: 1.3rem;"><?php echo date("d/m/y"); ?></strong>
      </p>
    </div>
  </div>
